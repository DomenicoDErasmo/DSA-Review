...
bool edgeTestEqualityOperator() {
    ...
    Edge<int> inequal_to_lhs(4);
    Edge<int> inequal_to_rhs(5);
    result &= !(inequal_to_lhs == inequal_to_rhs);

    Edge<int> inequal_weight_lhs(2, 1.4);
    Edge<int> inequal_weight_rhs(2, 1.5);
    result &= !(inequal_weight_lhs == inequal_weight_rhs);

    Edge<int> equal_lhs(1, 1.0001);
    Edge<int> equal_rhs(1, 1);
